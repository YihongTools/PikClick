...
- `dist/PikClick-v2.1.2-release.apk.sha256`
...
& $apksigner.FullName verify --verbose --print-certs .\dist\PikClick-v2.1.2-release.apk
Get-FileHash .\dist\PikClick-v2.1.2-release.apk -Algorithm SHA256
```
